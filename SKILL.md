...
description: |
  ...
  ── 约束 6：图片生成（封面 + 配图）
  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  所有图片 prompt 必须用五要素结构 + 意疏AI口袋品牌视觉（哆啦A梦元素），
  禁止「XX 风格插画」等空泛描述。
  默认引擎：qwen（千问）；封面尺寸默认 900*383（2.35:1），自动压缩到 800KB。

  ── 约束 7：五要素 + Doraemon 视觉结构
  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  封面 prompt = <哆啦A梦风格场景 + 核心意象>，<情绪基调>，
  <哆啦A梦风格画面>，2.35:1 横向构图，主体居中偏左，
...
3. 画面风格（按主题选：
   - 鸡汤情感 → 扁平插画，马卡龙色系
   - 科技数码 → 深蓝紫渐变，微缩等距风格
   - AI 知识科普 → Bento 几何信息图风格（蓝青 + 霓虹线条，高级感）
   - AI 历史人文 → 硅基复古版画风格（做旧纸张 + 赛博朋克，厚重感）
   - AI 工具实战 → 数字质感物相风格（玻璃晶体 + 光影对比，实体感）
   - 健康养生 → 清新水彩，自然光
   - 财经商业 → 极简商务，金蓝撞色
   - 文艺生活 → 胶片质感，柔焦颗粒
   - 历史人文 → 复古版画，做旧纸张
...
**合格示例：**`蓝色圆滚滚的哆啦A梦从抽屉里跳出来，身边散落竹蜻蜓和铜锣烧，一个普通小学生坐在草地上仰头望着它，温暖治愈，扁平插画，哆啦A梦原色蓝，2.35:1 横向构图，主体居中偏左，右上角嵌入小字「意疏AI口袋」，中部区域小字「AI编程」（避开底部 15% 遮挡区），画面主体不要出现任何文字、字母、汉字，水印、logo、签名`
...
3. **生成封面图片**
   ...
   - 示例：
     ```bash
     # 使用千问生成（默认）—— prompt 必须遵循五要素结构 + 哆啦A梦视觉
     python3 scripts/generate_cover.py --prompt "蓝色圆滚滚的哆啦A梦从抽屉里跳出来，身边散落竹蜻蜓和铜锣烧，一个背着书包的普通小学生坐在草地上仰头望着它，温暖治愈，扁平插画，哆啦A梦原色蓝，2.35:1 横向构图，主体居中偏左，右上角嵌入小字「意疏AI口袋」，中部区域小字「AI编程」（避开底部 15% 遮挡区），画面主体不要出现任何文字、字母、汉字，水印、logo、签名"
...
3. 生成封面（按五要素结构构造 prompt，禁用空泛描述）
   python3 scripts/generate_cover.py --prompt "<蓝色哆啦A梦场景>，<情绪基调>，<哆啦A梦风格画面>，2.35:1 横向构图，主体居中偏左，右上角嵌入小字「意疏AI口袋」，中部区域小字「标题关键词」（避开底部 15% 遮挡区），画面主体不要出现任何文字、字母、汉字，水印、logo、签名" --provider qwen
...
3. 三遍审校（按 references/三遍审校清单.md 执行）
   ...
   - 第二遍 风格：删 AI 套话 + 加态度
   - 第三遍 细节：句长 / 标点 / 中英文空格
4. 生成封面（按五要素结构 + 哆啦A梦视觉）
   python3 scripts/generate_cover.py --prompt "蓝色圆滚滚的哆啦A梦从抽屉里跳出来，身边散落竹蜻蜓和铜锣烧，一个背着书包的普通小学生坐在草地上仰头望着它，温暖治愈，扁平插画，哆啦A梦原色蓝，2.35:1 横向构图，主体居中偏左，右上角嵌入小字「意疏AI口袋」，中部区域小字「AI编程」（避开底部 15% 遮挡区），画面主体不要出现任何文字、字母、汉字，水印、logo、签名" --provider qwen
5. 上传封面并创建草稿
   （同上）
...
| 文章主题 | 视觉风格 | 配色与质感 | 典型 prompt 关键词 |
| --- | --- | --- | --- |
| 鸡汤情感 | 扁平插画 | 马卡龙色系，轻盈柔和 | 温暖治愈，扁平插画 |
| 科技数码 | 深蓝紫渐变 | 微缩等距风格，未来感 | 专业冷静，微缩等距 |
| **AI 知识科普** | Bento 几何信息图 | 深蓝青 + 霓虹线条，干净数字感 | 专业冷静，几何信息图 |
| **AI 历史人文** | 硅基复古版画 | 做旧纸张 + 赛博朋克，厚重感 | 怀旧沉思，复古未来 |
| **AI 工具实战** | 数字质感物相 | 玻璃晶体 + 光影对比，实体感 | 专业冷静，高对比光影 |
| 健康养生 | 清新水彩 | 自然光，柔和色调 | 轻松愉悦，清新水彩 |
| 财经商业 | 极简商务 | 金蓝撞色，稳重专业 | 专业冷静，极简商务 |
| 文艺生活 | 胶片质感 | 柔焦颗粒，电影感 | 轻松愉悦，胶片质感 |
| 历史人文 | 复古版画 | 做旧纸张，经典厚重 | 怀旧沉思，复古版画 |
| 美食探店 | 食物特写 | 浅景深，食欲感 | 轻松愉悦，食物特写 |
...
### 合格 prompt 示例（封面图 · 意疏AI口袋 · 哆啦A梦视觉）

文章主题："上班族用 AI 工具节省下班时间"

```
蓝色圆滚滚的哆啦A梦从抽屉里跳出来，身边散落竹蜻蜓和铜锣烧，
一个背着书包的普通小学生坐在草地上仰头望着它，
温暖治愈，扁平插画，哆啦A梦原色蓝，
2.35:1 横向构图，主体居中偏左，右上角嵌入小字「意疏AI口袋」，中部区域小字「AI编程」（避开底部 15% 遮挡区），画面主体不要出现任何文字、字母、汉字，水印、logo、签名
```

### AI 主题视觉风格示例（可替换上方哆啦A梦示例）
