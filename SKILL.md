...
3. 画面风格（按主题选：
   - 鸡汤情感 → 扁平插画，马卡龙色系
   - 科技数码 → 深蓝紫渐变，微缩等距风格（**强制 flat composition，约束为 900:383**）
   - AI 知识科普 → Bento 几何信息图（蓝青 + 霓虹线条，**加 clean typography，无背景杂物**）
   - AI 历史人文 → 硅基复古版画（做旧纸张 + **混古典蚀刻与霓虹电路**）
   - AI 工具实战 → 数字质感物相（玻璃晶体 + 光影对比，**加 macro shot，极浅景深，文字投影在物体上**）
   - 零售/商业运营 → 毛玻璃商务流（Glassmorphism，蓝绿渐变，中央卡片，效率图表）
   - SOP 拆解/教程 → 分步路径图（发光数字节点，图标，分步指南，干净背景）
   - 职场进阶/个人成长 → 虚拟实体质感（3D 极简物体特写，实体光影，居中大字）
   - 健康养生 → 清新水彩，自然光
   - 财经商业 → 极简商务，金蓝撞色
   - 文艺生活 → 胶片质感（**文字不做柔焦，强制 clean text overlay**）
   - 历史人文 → 复古版画，做旧纸张
   - 美食探店 → 食物特写（**文字放在最清晰平面，center background 虚化，text clearly focused**）
...
| AI 知识科普 | Bento 几何信息图 | 深蓝青 + 霓虹线条，**clean typography，无背景杂物** | 专业冷静，几何信息图 |
