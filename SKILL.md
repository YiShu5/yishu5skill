...
description: |
  ...
  ── 约束 5：字数
  ━━━━━━━━━━━━━━━━━━━
  默认 1200-1500 字；AI 技术/评测/工具类文章 2000-3500 字（参考 CHICKEN_SOUP_STYLE.md）。
  ...
  <哆啦A梦风格画面>，16:9 横向构图，主体居中偏左，留白用于标题文字，
...
**合格示例：**`蓝色圆滚滚的哆啦A梦从抽屉里跳出来，身边散落竹蜻蜓和铜锣烧，一个普通小学生坐在草地上仰头望着它，温暖治愈，扁平插画，哆啦A梦原色蓝，16:9 横向构图，主体居中偏左，留白用于标题文字，画面中不要出现任何文字、字母、汉字、水印、logo、签名`
...
3. **生成封面图片**
   ...
   - 示例：
     ...
     python3 scripts/generate_cover.py --prompt "蓝色圆滚滚的哆啦A梦从抽屉里跳出来，身边散落竹蜻蜓和铜锣烧，一个背着书包的普通小学生坐在草地上仰头望着它，温暖治愈，扁平插画，哆啦A梦原色蓝，16:9 横向构图，主体居中偏左，留白用于标题文字，画面中不要出现任何文字、字母、汉字、水印、logo、签名"
...
3. 生成封面（按五要素结构构造 prompt，禁用空泛描述）
   python3 scripts/generate_cover.py --prompt "<蓝色哆啦A梦场景>，<情绪基调>，<哆啦A梦风格画面>，16:9 横向构图，主体居中偏左，留白用于标题文字，画面中不要出现任何文字、字母、汉字、水印、logo、签名" --provider qwen
...
4. 生成封面（按五要素结构 + 哆啦A梦视觉）
   python3 scripts/generate_cover.py --prompt "蓝色圆滚滚的哆啦A梦从抽屉里跳出来，身边散落竹蜻蜓和铜锣烧，一个背着书包的普通小学生坐在草地上仰头望着它，温暖治愈，扁平插画，哆啦A梦原色蓝，16:9 横向构图，主体居中偏左，留白用于标题文字，画面中不要出现任何文字、字母、汉字、水印、logo、签名" --provider qwen
5. 上传封面并创建草稿
   （同上）
