...
description: |
  ...
  禁止「XX 风格插画」等空泛描述。
  默认引擎：qwen（千问）；封面尺寸默认 1664*928，自动压缩到 800KB。

  ── 约束 7：五要素 + Doraemon 视觉结构
  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  封面 prompt = <哆啦A梦风格场景 + 核心意象>，<情绪基调>，
  <哆啦A梦风格画面>，16:9 横向构图，主体居中偏左，
  <右上角留白区域>，嵌入小字「意疏AI口袋」（白色或浅金色，字体干净，不要挡住主体），
  <标题关键词 3-5 个>，用小字浮于画面底部（颜色浅、不喧宾夺主），
...
4. 构图：固定 `16:9 横向构图，主体居中偏左，右上角嵌入小字「意疏AI口袋」，底部小字「标题关键词」`
...
**合格示例：**`蓝色圆滚滚的哆啦A梦从抽屉里跳出来，身边散落竹蜻蜓和铜锣烧，一个普通小学生坐在草地上仰头望着它，温暖治愈，扁平插画，哆啦A梦原色蓝，16:9 横向构图，主体居中偏左，右上角嵌入小字「意疏AI口袋」，底部小字「AI编程」，画面主体不要出现任何文字、字母、汉字，水印、logo、签名`
...
3. **生成封面图片**
   ...
   - 示例：
     ...
     python3 scripts/generate_cover.py --prompt "蓝色圆滚滚的哆啦A梦从抽屉里跳出来，身边散落竹蜻蜓和铜锣烧，一个背着书包的普通小学生坐在草地上仰头望着它，温暖治愈，扁平插画，哆啦A梦原色蓝，16:9 横向构图，主体居中偏左，右上角嵌入小字「意疏AI口袋」，底部小字「AI编程」，画面主体不要出现任何文字、字母、汉字，水印、logo、签名"
...
3. 生成封面（按五要素结构构造 prompt，禁用空泛描述）
   python3 scripts/generate_cover.py --prompt "<蓝色哆啦A梦场景>，<情绪基调>，<哆啦A梦风格画面>，16:9 横向构图，主体居中偏左，右上角嵌入小字「意疏AI口袋」，底部小字「标题关键词」，画面主体不要出现任何文字、字母、汉字，水印、logo、签名" --provider qwen
...
4. 生成封面（按五要素结构 + 哆啦A梦视觉）
   python3 scripts/generate_cover.py --prompt "蓝色圆滚滚的哆啦A梦从抽屉里跳出来，身边散落竹蜻蜓和铜锣烧，一个背着书包的普通小学生坐在草地上仰头望着它，温暖治愈，扁平插画，哆啦A梦原色蓝，16:9 横向构图，主体居中偏左，右上角嵌入小字「意疏AI口袋」，底部小字「AI编程」，画面主体不要出现任何文字、字母、汉字，水印、logo、签名" --provider qwen
5. 上传封面并创建草稿
   （同上）
...
cover_prompt="发布会舞台中央的新版应用界面投影，前排观众举起手机拍摄，灯光聚焦，专业冷静，极简商务，金蓝撞色，16:9 横向构图，主体居中偏左，右上角嵌入小字「意疏AI口袋」，底部小字「效率工具」，画面主体不要出现任何文字、字母、汉字，水印、logo、签名"
...
python3 scripts/generate_cover.py \
  --prompt "<核心意象>，<情绪基调>，<画面风格>，16:9 横向构图，主体居中偏左，右上角嵌入小字「意疏AI口袋」，底部小字「标题关键词」，画面主体不要出现任何文字、字母、汉字，水印、logo、签名" \
  --output cover.jpg
...
3. **画面风格**：按文章主题从下表挑选——
   ...
   - 历史人文 → 复古版画，做旧纸张
   - 美食探店 → 食物特写摄影感，浅景深
4. **构图与镜头**：固定为 `16:9 横向构图，主体居中偏左，右上角嵌入小字「意疏AI口袋」，底部小字「标题关键词」`。
...
温暖治愈，扁平插画，哆啦A梦原色蓝，
16:9 横向构图，主体居中偏左，右上角嵌入小字「意疏AI口袋」，底部小字「AI编程」，画面主体不要出现任何文字、字母、汉字，水印、logo、签名
```
